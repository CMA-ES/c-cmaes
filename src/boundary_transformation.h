 ...
 * */
void boundary_transformation(cmaes_boundary_transformation_t *,
		double const *x, double *y, unsigned long len); /* new value into y */

/* after
 *   boundary_transformation(b,x,y,l) ;
 * the two consecutive calls
 *   cmaes_boundary_transformation_inverse(b,y,x,l) ; boundary_transformation(b,x,y,l) ;
 ...
 * the two consecutive calls
 *   boundary_transformation(b,x,y,l) ; cmaes_boundary_transformation_inverse(b,y,x,l) ;
